    ...
    function UpdateTheme(theme){
        ...
        setProp('--background-default-hover', theme.mainBackgroundColourHover) //  Backgorund color of the chatlist and some other things while hover
        ...
        // Message input
        setProp('--compose-background', theme.inputFieldBackground) // Basicaly the background of message input
        ...
        setProp('--panel-background-deeper', theme.outgoingMessageBackgroundDeeper); // The colour behing of input placeholder when sharing files/images
